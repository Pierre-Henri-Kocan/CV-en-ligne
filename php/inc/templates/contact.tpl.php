...
$message = 'Merci pour votre message, je reviens vers vous dans les meilleurs délais concernant votre message : ' . PHP_EOL . PHP_EOL . $_POST['message'];
$headers = [
    'From' => 'contact@pierre-henri-kocan.com',
];
